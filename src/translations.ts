...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    micPermissionDesc: 'Earforge uses your microphone strictly for real-time pitch detection on your device. Audio is never recorded or uploaded.',
  ...
  tr: {
    ...
    micPermissionDesc: 'Earforge, cihazınızda gerçek zamanlı perde algılaması yapmak için mikrofonu kullanır. Sesler asla kaydedilmez veya yüklenmez.',
  ...
  de: {
    ...
    micPermissionDesc: 'Earforge nutzt Ihr Mikrofon ausschließlich zur Echtzeit-Tonhöhenerkennung auf Ihrem Gerät. Audiodaten werden niemals aufgezeichnet oder hochgeladen.',
